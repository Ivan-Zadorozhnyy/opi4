...
class FlaskTestCase(TestCase):
    ...
    def test_update_valid_user(self):
        ...
        response = self.client.put(
            f"/api/user/update?userId={user_id}",
...
class FlaskE2ETestCase(unittest.TestCase):
    ...
    def test_total_time_e2e(self):
        self.driver.get(
            "http://127.0.0.1:5000/api/stats/user/total?userId=044fea9b-822a-4f44-832b-1808719277b2"
        )
    ...
    def test_average_time_e2e(self):
        self.driver.get(
            "http://127.0.0.1:5000/api/stats/user/average?userId=044fea9b-822a-4f44-832b-1808719277b2"
        )
        body_text = self.driver.find_element(By.TAG_NAME, "body").text
        response_data = json.loads(body_text)
    ...
    def test_forget_user_e2e(self):
        ...
        self.driver.get(
            f"http://127.0.0.1:5000/api/user/forget?userId={user_id_to_forget}"
        )
